...
project_root = '/media/a204/742CCF0E2CCEC9F6/DiZ_gogogo/DeepLeaning/pan_pp_stable_to_power/E2E_CVTD/'

input_dir = project_root + 'outputs/submit_tt/'
gt_dir = project_root + 'data/totaltext/groundtruth_text/Groundtruth/Polygon/Test'
