...
class ResNet(nn.Module):
    ...
    def forward(self,
        ...
        # feature_kernel_4 = self.mp(f[:, 0:hidden_dim])
        ...
        if self.training:
            loss_det = self.detection_head.loss(
                ...
                training_masks,
                gt_instances,
                gt_bboxes, args=args, feature_kernel=None)
