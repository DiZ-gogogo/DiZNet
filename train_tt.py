...
train_time = "_{}_{}{}_{}_{}_{}".format(time_tuple[0], time_tuple[1], time_tuple[2], time_tuple[3],
                                        time_tuple[4],
                                        time_tuple[5])
...
extra_mes = 'XIAORONG_DET_TT_3_FPEFM_S640_' + train_time


def main(args):
    if args.checkpoint == '':
        args.checkpoint = 'checkpoints/{}/{arch}_{img_size}'.format(
            extra_mes,
            arch=args.arch,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--epoch', nargs='?', type=int, default=750)
