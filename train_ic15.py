...
#
# torch.manual_seed(1234526)
# torch.cuda.manual_seed(1234526)
...
def train(args, train_loader, model, optimizer, epoch, start_iter):
    ...
    for batch_idx, (imgs, gt_texts, gt_kernels, training_masks, gt_instances,
                    gt_bboxes, gt_words, word_masks, cannys) in enumerate(train_loader):
...
train_time = "Det_Pretrained_IC15_S736_2_FPEFM_{}_{}{}_{}_{}_{}".format(time_tuple[0], time_tuple[1], time_tuple[2], time_tuple[3],
                                                         time_tuple[4],
                                                         time_tuple[5])
...
if __name__ == '__main__':
    ...
    parser.add_argument('--epoch', nargs='?', type=int, default=700)
    ...
    parser.add_argument('--kernel_scale', nargs='?', type=float, default=0.6)
