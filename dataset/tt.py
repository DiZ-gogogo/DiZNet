...
tt_train_gt_dir = tt_root_dir + 'groundtruth_text/Groundtruth/Polygon/Train/'
tt_train_gt_canny = tt_root_dir + 'cannys/tt_train_canny/'
tt_test_data_dir = tt_root_dir + 'Images/Test/'
tt_test_gt_dir = tt_root_dir + 'groundtruth_text/Groundtruth/Polygon/Test/'
tt_test_gt_canny = tt_root_dir + 'cannys/tt_test_canny/'
...
class TTLoader(data.Dataset):
    def __init__(self,
        ...
        if split == 'train':
            ...
            gt_cannys = [tt_train_gt_canny]

            print('kernel_scale: %f' % self.kernel_scale)
        else:
            data_dirs = [tt_test_data_dir]
            gt_dirs = [tt_test_gt_dir]
            gt_cannys = [tt_test_gt_canny]

        self.img_paths = []
        self.gt_paths = []
        self.canny_paths = []

        for data_dir, gt_dir, canny_dir in zip(data_dirs, gt_dirs, gt_cannys):
