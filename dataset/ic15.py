...
EPS = 1e-6
ic15_root_dir = './data/ICDAR2015/Challenge4/Text_Localization_2015/'
...
ic15_train_gt_canny = ic15_root_dir + 'icdar2015_train_canny/'
ic15_test_data_dir = ic15_root_dir + 'ch4_test_images/'
ic15_test_gt_dir = ic15_root_dir + 'Challenge4_Test_Task1_GT/'
ic15_test_gt_canny = ic15_root_dir + 'icdar2015_test_canny/'


# 训练 CVT 数据
# EPS = 1e-6
# ic15_root_dir = './data/CVT_Datasets/'
# ic15_train_data_dir = ic15_root_dir + 'train/'
# ic15_train_gt_dir = ic15_root_dir + 'gt_train/'
# ic15_train_gt_canny = ic15_root_dir + 'CVT_train_canny/'
# ic15_test_data_dir = ic15_root_dir + 'val/'
# ic15_test_gt_dir = ic15_root_dir + 'gt_val/'
# ic15_test_gt_canny = ic15_root_dir + 'CVT_val_canny/'
...
class IC15Loader(data.Dataset):
    def __init__(self,
        ...
        if split == 'train':
            ...
            canny_dirs = [ic15_train_gt_canny]

        else:
            data_dirs = [ic15_test_data_dir]
            gt_dirs = [ic15_test_gt_dir]
            canny_dirs = [ic15_test_gt_canny]
    ...
    def prepare_training_data(self, index):
        ...
        if self.is_transform:
            ...
            # print("caprepare_training_datanny shape:",canny.shape)
        ...
        # canny = transforms.Normalize(
        #     mean=[0.485, 0.456, 0.406],
        #     std=[0.229, 0.224, 0.225])(canny)
        ...
        return img, gt_text, gt_kernels, training_mask, gt_instance, \
               gt_bboxes, gt_words, word_mask, canny
