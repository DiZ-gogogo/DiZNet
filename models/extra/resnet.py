...
from models.extra.ThresholdActivateCA import CoordAttention

from models.extra.ThresholdMap import ThresholdMap

feature_kernel_model = ThresholdMap(in_channels=6, out_channels=1).to("cuda")
...
class ResNet(nn.Module):
    ...
    def forward(self,
        ...
        feature_kernel = feature_kernel_model(out_det)
        ...
        if self.training:
            loss_det = self.detection_head.loss(
                ...
                training_masks,
                gt_instances,
                gt_bboxes, args=args, feature_kernel=feature_kernel)
