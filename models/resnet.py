...
class FPEM(nn.Module):
    ...
    def forward(self, f1, f2, f3, f4, f1_o, f2_o, f3_o, f4_o):
        ...
        # print("before f1.shape:",f1.shape,-----------dui bi 2023/8/17)
...
from models.extra.ThresholdActivateCAV3 import CoordAttention
    ...
    def forward(self,
        ...
        if self.training:
            loss_det = self.detection_head.loss(
                ...
                training_masks,
                gt_instances,
                gt_bboxes, args=args, cannys=cannys, feature_kernel=feature_kernel)
        ...
        if self.recognition_head is not None:
            if self.training:
                x_crops, gt_words = self.recognition_head.extract_feature(
                    ...
                    word_masks, feature_kernel=feature_kernel,out_det=out_det)
