...
def test(args):
    ...
    for idx, (org_img, img) in enumerate(test_loader):
        ...
        with torch.no_grad():
            ...
            # new_model = torchvision.models._utils.IntermediateLayerGetter(model, {"se_module_ext": 1})
            #
            #
            # print(new_model)
            # print(img.shape)
            ...
            # print("feature_map shape",v.shape)  # torch.Size([512, 28, 28])
            ...
            # plt.savefig(
            #         "./feature_maps/{}/{}/.jpg".format(feature_extractor_layer, str(idx),time.mktime(time.localtime())))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--vis', nargs='?', type=str2bool, default=True)
